...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {  // start 5ms timed loop  
      ...
      if (stepFlag == 1 && currentMillis - previousStepMillis > 1200) {
        pot1 = 1024;
        pot2 = 1024;
        pot6 = 1024;
        stepFlag = 2;           
      ...
      servo1.writeMicroseconds(pot2Smoothed);
      //servo1.writeMicroseconds((pot6Smoothed - pot5Smoothed));                              // neck rotate
      servo2.writeMicroseconds(pot2Smoothed);      // neck side-side
      ...
      servo3.writeMicroseconds(pot6Smoothed+500);
      //pot6Smoothed=pot6Smoothed-1500;
      //pot6Smoothed = constrain(pot6Smoothed,900,1500);
      servo6.writeMicroseconds(pot6Smoothed-1000);                     // eyelids
      

      //servo1.writeMicroseconds(2500-(pot6Smoothed + pot5Smoothed));                     // eyelids
